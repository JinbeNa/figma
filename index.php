   ...
   <div class="all">
      ...
      <footer class="footer ">
         ...
         <div class="footer__link">
            <div class="footer__link__box container pad-1-lr pd-t-b-2-25">
               <div class="link__box grid-clos-3 ">
         ...
         <div class="auth-form tabcontent" id="Sigin" style="display: none;">
            ...
            <div class="auth-form__socials">
               <a href="" class="bnt bnt--with-icon fb">
                  <i class="social__icon icon--fb fa-brands fa-square-facebook"></i>
                  <span class="socials--title">Kết nối với Facebook</span>
               </a>
               <a href="" class="bnt bnt--with-icon gg">
                  <i class="social__icon icon--gg fa-brands fa-google"></i>
